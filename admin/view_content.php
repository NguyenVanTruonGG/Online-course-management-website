   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Bạn chắc chắc muốn xóa video?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">Chưa có nội dung nào được thêm vào! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Thêm videos</a></p>';
   }
...
<section class="comments">
   ...
   <h1 class="heading">Ý kiến người dùng</h1>
