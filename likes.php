...
<section class="liked-videos">
   ...
   <h1 class="heading">Videos đã thích</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <input type="submit" value="Gỡ bỏ" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
      ...
      echo '<p class="empty">Chưa có lượt thích!</p>';
   }
   ?>
